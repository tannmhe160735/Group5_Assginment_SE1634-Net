                        ...
                        <table class="b" style="width: 25vw; margin-left: 1vw">
                            <th>Tên giày</th>
                                ...
                                <tr
                                    ...
                                    </dava:if>><td><a href="ListOfFeedbackOnEachProduct?product_id=${aIdAndTitleOfProduct.product_id}">${aIdAndTitleOfProduct.title}</a></td></tr>
                                        </dava:forEach>
                        </table>
                    </td>
                    <td valign='top'>
                        <table class="b" style="width: 53vw; margin-right:  1vw">
                            <th>Feedback</th>
                                ...
                                <tr>
                                    <td><myCustomTag:Star_Format numberOfStarOfComment="${FeedbackStarAndContent.numberOfStar}"/>${FeedbackStarAndContent.feedbackContent}
                                        ...
                                        <a class="a" href="EditFeedback?feed_id=${FeedbackStarAndContent.feedbackID}" style="float:right;text-align:right;"><button>Edit</button></a>
                                    </dava:if>
                                        </td>
                                </tr>
                            </dava:forEach>
