...
<html>
    ...
    <body>
        <table class ="a">
            ...
            <tr><td><table class ="c"><td style="width: 28vw"><img src="../assets/img/img_for_posts/Screenshot 2022-10-02 220116.png" alt=""/></td><td style="width: 69vw"><h5 style="font-size: 30px;margin-top: 1px;margin-bottom: 5px">Mẫu giày nữ tính phù hợp để tặng nhân ngày ...</h5><p style="font-size: 25px"><a href="../ViewDetailPost?post_id=2">Adidas gửi một lời nhắc nhở mọi người hãy yêu thương bản thân mình trong ngày lễ tình nhân sắp đến. Mặc dù phiên bản đặc biệt hầu như vẫn tương tự...</a></p></td></table></td></tr>
